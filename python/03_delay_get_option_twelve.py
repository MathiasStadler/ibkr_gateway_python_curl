    ...
    if FILTER_DELTA:
        ...
        for c in put_contracts:
            ...
            try:
                ...
                passpython 03_delay_get_option_twelve.py PLTR
2026-05-13 18:01:31,566 - INFO - Processing ticker: PLTR, next 4 months
2026-05-13 18:01:31,566 - INFO - Delta filter: ON (range -0.50 to -0.30)
2026-05-13 18:01:31,704 - ERROR - Failed to search for PLTR: 'str' object has no attribute 'get'
