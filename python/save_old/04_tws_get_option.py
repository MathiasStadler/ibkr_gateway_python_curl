...
def get_option_snapshot_bulk(conids, fields="84,85,86,87,88,89", generic_ticks="100,101,104,106", max_attempts=3, delay=2, batch_size=10):
    ...
    - generic_ticks: Option Volume (100), Option Open Interest (101), 
                     Historical Volatility (104), Option Implied Volatility (106)
    """
    if not conids:
        return {}
    ...
    for i in range(0, len(conids), batch_size):
        ...
        url = f'https://localhost:4002/v1/api/iserver/marketdata/snapshot?conids={conid_str}&fields={fields}&genericTickList={generic_ticks}&delay=1&snapshot=1&marketDataType=DELAYED'
...
if __name__ == "__main__":
    ...
    # Verwende die Monate in der von der API gelieferten Reihenfolge
