...
def get_option_snapshot_bulk(conids, fields="84,85,86,87,88,89,100,101", max_attempts=2, delay=2, batch_size=10):
    """
    Abruf von Marktdaten: Bid (84), Ask (85), Delta (86), Gamma (87), Theta (88), Vega (89),
    Volumen (100), Open Interest (101).
    """
    if not conids:
        return {}
