...
def write_debug_log(contracts_list, filename="option_debug.log"):
    """Schreibt alle Optionen (vor Filter) als JSON-Log."""
...
def writeResult(contracts_list):
    ...
    # Debug-Log aller Optionen (mit Marktdaten)
    write_debug_log(contracts_list)

    # Debug: Erste 5 Deltas anzeigen
    ...
    # Filter nach Optionstyp (nur Puts)
    if FORCE_PUT_ONLY:
